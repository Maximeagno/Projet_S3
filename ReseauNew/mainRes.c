...
//main with preprocess
  ...
  char *path5 = "../../amelie.bertin/Preprocess/Images_test/Text3";
  ...
  char *path2 = "../../amelie.bertin/Preprocess/Images_test/text-autre3.jpg";
